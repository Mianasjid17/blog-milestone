...
import styles from './AboutLocalHeader.module.css'

const AboutLocalHeader = () => {
  ...
  return (
    ...
    <div className={styles.bg_img_container}>
      ...
      <div className={styles.content}>
        <h1 className={styles.heading_two}>Learn more <span className='text-orange-700'>About Us</span></h1>
...
export default AboutLocalHeader
